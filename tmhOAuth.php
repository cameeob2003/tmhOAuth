        ...
        switch ($this->request_settings['method']) {
            ...
            case 'POST':
                ...
                if (isset($this->request_settings['postfields'])) {
                    ...
                    if (isset($postfields['status'])) {
                        $postfields['status'] = htmlspecialchars($postfields['status']);
                    }
                } else {
                    $postfields = array();
                }
                // Will need to mnodified in the future to use $args['file'] = new CurlFile('filename.png', 'image/png');
